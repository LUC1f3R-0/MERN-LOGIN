...
// node_modules/sweetalert2/src/utils/draggable.js
var dragging = false;
var mousedownX = 0;
var mousedownY = 0;
var initialX = 0;
...
var render = (instance, params) => {
  ...
  globalState_default.eventEmitter.emit("didRender", popup);
};
...
var handlePopupAnimation = (instance, popup, innerParams) => {
  ...
  (_a = globalState_default.eventEmitter) == null ? void 0 : _a.emit("willClose", popup);
...
var animatePopup = (instance, popup, container, returnFocus, didClose) => {
  ...
  const swalCloseAnimationFinished = function(e) {
    var _a, _b;
    if (e.target === popup) {
      (_b = (_a = globalState_default).swalCloseEventFinishedCallback) == null ? void 0 : _b.call(_a);
...
var triggerDidCloseAndDispose = (instance, didClose) => {
  setTimeout(() => {
    ...
    (_a = globalState_default.eventEmitter) == null ? void 0 : _a.emit("didClose");
...
function _destroy() {
  ...
  globalState_default.eventEmitter.emit("didDestroy");
  disposeSwal(this);
}
...
globalState_default.eventEmitter = new EventEmitter();
var on = (eventName, eventHandler) => {
  globalState_default.eventEmitter.on(eventName, eventHandler);
};
var once = (eventName, eventHandler) => {
  globalState_default.eventEmitter.once(eventName, eventHandler);
};
var off = (eventName, eventHandler) => {
  if (!eventName) {
    globalState_default.eventEmitter.reset();
    return;
  }
  if (eventHandler) {
    globalState_default.eventEmitter.removeListener(eventName, eventHandler);
  } else {
    globalState_default.eventEmitter.removeAllListeners(eventName);
  }
};
...
var openPopup = (params) => {
  ...
  globalState_default.eventEmitter.emit("willOpen", popup);
  ...
  globalState_default.eventEmitter.emit("didOpen", popup);
